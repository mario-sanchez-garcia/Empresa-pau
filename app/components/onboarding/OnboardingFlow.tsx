          ...
          <div style={{ width: '100%', maxWidth: 400 }}>
            ...
            {authError && (
              <div style={{ marginBottom: 18 }}>
                ...
                <p style={{ margin: '8px 0 0', fontSize: 11, color: 'rgba(255,255,255,.4)' }}>¿Sigue sin funcionar? <a href={`mailto:${SUPPORT_EMAIL}`} className="su-link">Escríbenos a soporte</a>.</p>
              </div>
            )}
            ...
            {signupOptionsReady ? (
              <>
                ...
                <div style={{ marginBottom: 8 }}>
                  <button type="button" className="su-btn-google" onClick={handleGoogleSignup} disabled={signupBusy !== null} aria-busy={signupBusy === 'google'} aria-label="Crea tu cuenta con Google">
                    ...
                    {signupBusy === 'google' ? 'Abriendo Google…' : 'Crea tu cuenta con Google'}
                  </button>
                </div>
                ...
                <div style={{ marginTop: 22 }}>
                  <button
                    ...
                    disabled={!email || !password || !terms || signupBusy !== null}
                    aria-busy={signupBusy === 'email'}
                  >
                    {signupBusy === 'email' ? 'Creando tu cuenta…' : 'Crear mi cuenta'}
                  </button>
                </div>
              </>
            ) : (
