-- seed_curriculum_content.sql
-- Apuntes de Diego (LaTeX → Markdown) — Matemáticas II
-- 8 filas para curriculum_content — NO ejecutar sin revisar primero
...
-- ════════════════════════════════════════
-- geometria-3d:producto-vectorial (slug existente)
-- Vectores, Rectas, Planos y Geometría Métrica (Ch4, Ch5, Ch6)
INSERT INTO curriculum_content (subject, block_slug, topic_slug, content_markdown)
VALUES (
  'matematicas_ii',
  'geometria-3d',
...
## 1. La Recta en el Espacio (Ecuaciones)
...
## 3. Posiciones Relativas (Apartados 3 y 4 del PDF)
...
## 4. Ángulos en el Espacio (Apartado 1 del PDF)
...
## 5. Proyecciones Ortogonales y Puntos Simétricos (Apartado 2)
...
## 6. Distancias en el Espacio (Apartado 3 del PDF)
...
## 7. Áreas y Volúmenes (Apartado 4 del PDF)
