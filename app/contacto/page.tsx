...
const card: React.CSSProperties = { background: 'white', borderRadius: 16, padding: '18px 20px', display: 'flex', gap: 16, alignItems: 'flex-start', boxShadow: '0 4px 16px rgba(37,99,235,0.06)', border: '1px solid #e5e7eb' }
