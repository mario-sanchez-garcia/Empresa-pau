...
class Media {
  ...
  scene: any; screen: any; text: string; viewport: any; bend: number; textColor: string
  borderRadius: number; font: string; program: any; plane: any; title: any
  speed = 0; width = 0; widthTotal = 0; x = 0; padding = 0; scale = 0
...
class App {
  ...
  boundOnResize: any; boundOnWheel: any; boundOnTouchDown: any; boundOnTouchMove: any
  boundOnTouchUp: any; boundOnKeyDown: any
  ...
  onTouchMove(e: any) { if (!this.isDown) return; const x = e.touches ? e.touches[0].clientX : e.clientX; const distance = (this.start - x) * (this.scrollSpeed * 0.025); this.scroll.target = (this.scroll.position ?? 0) + distance }
...
export default function CircularGallery({
  ...
  return (
    <div
      ...
      tabIndex={0}
      role="region"
      aria-label="Galería de imágenes. Usa las flechas del teclado para navegar."
    />
  )
}
