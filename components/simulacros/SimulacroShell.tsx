...
export default function SimulacroShell({ children, title, subtitle, actions }: SimulacroShellProps) {
  return (
    <div className="kairo-premium-shell flex min-h-screen text-slate-900 max-lg:block">
      <Sidebar />

      <div className="min-w-0 flex-1">
        <header className="kairo-topbar sticky top-0 z-40 flex items-center justify-between gap-4 px-8 max-md:flex-wrap max-md:px-4" style={{ minHeight: 64 }}>
          <div>
