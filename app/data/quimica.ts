...
[
  {
    ...
    preguntas: [
      {
        id: "q-2018-A-1",
        topicSlugs: ["numeros-cuanticos-y-orbitales-atomicos","configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","el-enlace-metalico-y-propiedades-de-los-metales"],
        año: 2018,
...
d) Los números cuánticos $(n=3, l=1, m_l=-2, m_s=+\\frac{1}{2})$ corresponden a un electrón de este elemento.`,
      ...
      {
        id: "q-2018-A-2",
        topicSlugs: ["teorias-acido-base-arrhenius-y-br-nsted-lowry","ph-de-acidos-y-bases-debiles","fuerza-de-acidos-y-bases-ka-y-kb"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Datos. $K_a(\\text{HNO}_2) = 5{,}6 \\cdot 10^{-4}$; $K_a(\\text{HSO}_4^-) = 1{,}0 \\cdot 10^{-2}$; $K_a(\\text{ácido acético}) = 1{,}8 \\cdot 10^{-5}$; $K_a(\\text{ácido salicílico}) = 1{,}1 \\cdot 10^{-3}$; $K_b(\\text{amoniaco}) = 1{,}8 \\cdot 10^{-5}$.`,
      ...
      {
        id: "q-2018-A-3",
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
c) Nombre y escriba la fórmula del producto de la reacción de $\\text{CH}_3-\\text{CH}_2-\\text{CH}_2-\\text{CHO}$ con un reductor.`,
      ...
      {
        id: "q-2018-A-4",
        topicSlugs: ["grado-de-disociacion","el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Dato. $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$.`,
      ...
      {
        id: "q-2018-A-5",
        topicSlugs: ["potenciales-estandar-de-reduccion","espontaneidad-de-las-reacciones-redox","reacciones-de-oxidacion-reduccion"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos. $E^0$(V): $\\text{Fe}^{2+}$/Fe $= -0{,}44$; $\\text{Zn}^{2+}$/Zn $= -0{,}76$; $\\text{Ag}^+$/Ag $= 0{,}80$; $\\text{Cu}^{2+}$/Cu $= 0{,}34$; $\\text{Na}^+$/Na $= -2{,}71$; $\\text{Mn}^{2+}$/Mn $= -1{,}18$.`,
      ...
      {
        id: "q-2018-B-1",
        topicSlugs: ["numeros-cuanticos-y-orbitales-atomicos","configuracion-electronica-de-los-elementos","radio-atomico-y-radio-ionico","energia-de-ionizacion-y-afinidad-electronica"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta1",
...
d) Ordene los elementos por orden creciente de primera energía de ionización y justifique la respuesta.`,
      ...
      {
        id: "q-2018-B-2",
        topicSlugs: ["velocidad-de-reaccion","teoria-de-colisiones-y-energia-de-activacion"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
d) Explique cómo afecta a la velocidad de reacción un aumento de volumen a temperatura constante.`,
      ...
      {
        id: "q-2018-B-3",
        topicSlugs: ["la-electrolisis","potenciales-estandar-de-reduccion","leyes-de-faraday-de-la-electrolisis"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Datos. $E^0$(V): $\\text{Cl}_2/\\text{Cl}^- = 1{,}36$; $\\text{Na}^+$/Na $= -2{,}71$; $F = 96485$ C.`,
      ...
      {
        id: "q-2018-B-4",
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","concentracion-de-disoluciones","ph-de-acidos-y-bases-fuertes"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Datos. Masas atómicas: H = 1; O =16; S = 32.`,
      ...
      {
        id: "q-2018-B-5",
        topicSlugs: ["grupos-funcionales-y-nomenclatura-basica","formulacion-de-compuestos-oxigenados-y-nitrogenados","oxidacion-reduccion-en-quimica-organica","macromoleculas-y-polimeros"],
        año: 2018,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
de reacción.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2019-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica","el-atomo-de-bohr-y-los-espectros-atomicos","el-enlace-ionico-y-sus-propiedades"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
      ...
      {
        id: "q-2019-A-2",
        topicSlugs: ["hidrolisis-de-sales","ph-de-acidos-y-bases-fuertes"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Datos: $K_a(\\text{ácido acético}) = 1{,}8 \\cdot 10^{-5}$; $K_b(\\text{amoniaco}) = 1{,}8 \\cdot 10^{-5}$.`,
      ...
      {
        id: "q-2019-A-3",
        topicSlugs: ["reacciones-de-adicion","reacciones-de-eliminacion","reacciones-de-sustitucion","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
d) Ácido etanoico + propan-1-ol $\\rightarrow$`,
      ...
      {
        id: "q-2019-A-4",
        topicSlugs: ["grado-de-disociacion","el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio","mecanismos-de-reaccion-y-catalizadores"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Datos: $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$.`,
      ...
      {
        id: "q-2019-A-5",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","riqueza-o-pureza-de-un-reactivo","rendimiento-de-una-reaccion-quimica"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos: $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$; Masas atómicas: O = 16,0; Sn = 118,7.`,
      ...
      {
        id: "q-2019-B-1",
        topicSlugs: ["geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas","fuerzas-intermoleculares"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta1",
...
d) Indique las fuerzas intermoleculares que presentan.`,
      ...
      {
        id: "q-2019-B-2",
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","reacciones-de-sustitucion","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
metilo y ácido 2,3-dihidroxibutanoico.`,
      ...
      {
        id: "q-2019-B-3",
        topicSlugs: ["concentracion-de-disoluciones","equilibrios-heterogeneos-y-solubilidad-kps"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Datos. Masas atómicas: Cl = 35,5; Pb = 207,2.`,
      ...
      {
        id: "q-2019-B-4",
        topicSlugs: ["pilas-galvanicas","potenciales-estandar-de-reduccion","espontaneidad-de-las-reacciones-redox"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Datos. $E^0$(V): $\\text{Ag}^+$/Ag $= 0{,}80$; $\\text{Fe}^{2+}$/Fe $= -0{,}44$.`,
      ...
      {
        id: "q-2019-B-5",
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","concentracion-de-disoluciones","ph-de-acidos-y-bases-debiles","hidrolisis-de-sales"],
        año: 2019,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Datos: $K_b(\\text{amoniaco}) = 1{,}8 \\cdot 10^{-5}$. Masas atómicas: H = 1; N = 14.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2020-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","radio-atomico-y-radio-ionico","energia-de-ionizacion-y-afinidad-electronica"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
ionizar un mol de átomos de magnesio gaseosos con una energía de $500\\ \\text{kJ}$.`,
      ...
      {
        id: "q-2020-A-2",
        topicSlugs: ["hidrolisis-de-sales","ph-de-acidos-y-bases-debiles","ph-de-acidos-y-bases-fuertes"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Datos. $K_a(\\text{ácido acético}) = 1{,}8 \\cdot 10^{-5}$; $K_a(\\text{ácido hipobromoso}) = 2{,}3 \\cdot 10^{-9}$; $K_b(\\text{amoniaco}) = 1{,}8 \\cdot 10^{-5}$.`,
      ...
      {
        id: "q-2020-A-3",
        topicSlugs: ["reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","reacciones-de-sustitucion","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
d) Ácido propanoico + metanol (medio ácido) $\\rightarrow$`,
      ...
      {
        id: "q-2020-A-4",
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Dato. R = 0,082 atm·L·mol$^{-1}$·K$^{-1}$.`,
      ...
      {
        id: "q-2020-A-5",
        topicSlugs: ["pilas-galvanicas","potenciales-estandar-de-reduccion","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","riqueza-o-pureza-de-un-reactivo","rendimiento-de-una-reaccion-quimica","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos. $E^0$(V): $\\text{Zn}^{2+}$/Zn $= -0{,}76$; $\\text{Fe}^{2+}$/Fe $= -0{,}44$. R = 0,082 atm·L·mol$^{-1}$·K$^{-1}$. Masa atómica: Zn = 65,4.`,
      ...
      {
        id: "q-2020-B-2",
        topicSlugs: ["reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-adicion"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
d) $\\text{CH}_3-\\text{CH}=\\text{C}(\\text{CH}_3)-\\text{CH}_2-\\text{CH}_3 + \\text{HCl} \\rightarrow$`,
      ...
      {
        id: "q-2020-B-3",
        topicSlugs: ["equilibrios-heterogeneos-y-solubilidad-kps","ph-de-acidos-y-bases-fuertes"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Datos. Masas atómicas: H = 1,0; O = 16,0; Ca = 40,1.`,
      ...
      {
        id: "q-2020-B-4",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","rendimiento-de-una-reaccion-quimica","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Datos. Masas atómicas: Na = 23,0; Cl = 35,5. $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$.`,
      ...
      {
        id: "q-2020-B-5",
        topicSlugs: ["ph-de-acidos-y-bases-debiles","concentracion-de-disoluciones","hidrolisis-de-sales"],
        año: 2020,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Dato. $K_a(\\text{ácido peryódico}) = 2{,}3 \\cdot 10^{-2}$.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2021-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
      ...
      {
        id: "q-2021-A-2",
        topicSlugs: ["ph-de-acidos-y-bases-debiles","fuerza-de-acidos-y-bases-ka-y-kb"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Datos. $K_a(\\text{HNO}_2) = 4{,}5 \\cdot 10^{-4}$; $K_a(\\text{HF}) = 7{,}1 \\cdot 10^{-4}$; $K_a(\\text{HCN}) = 4{,}9 \\cdot 10^{-10}$.`,
      ...
      {
        id: "q-2021-A-3",
        topicSlugs: ["equilibrios-heterogeneos-y-solubilidad-kps"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
Datos. $E^0$(V): $\\text{Zn}^{2+}$/Zn $= -0{,}76$; $\\text{Cu}^{2+}$/Cu $= 0{,}34$.`,
      ...
      {
        id: "q-2021-A-5",
        topicSlugs: ["grupos-funcionales-y-nomenclatura-basica","formulacion-de-hidrocarburos","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-eliminacion","reacciones-de-adicion","reacciones-de-sustitucion"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
3-metilpentan-1-ol + $\\text{HBr}$ $\\rightarrow$`,
      ...
      {
        id: "q-2021-B-1",
        topicSlugs: ["geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas","fuerzas-intermoleculares","el-enlace-ionico-y-sus-propiedades"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta1",
...
reacción se produce en fase gaseosa.`,
      ...
      {
        id: "q-2021-B-3",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","rendimiento-de-una-reaccion-quimica","ley-de-los-gases-ideales-aplicada-a-reacciones","concentracion-de-disoluciones"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Datos. R = 0,082 atm·L·mol$^{-1}$·K$^{-1}$. Masas atómicas: H = 1,0; N = 14,0.`,
      ...
      {
        id: "q-2021-B-5",
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","formulacion-de-compuestos-oxigenados-y-nitrogenados","grupos-funcionales-y-nomenclatura-basica"],
        año: 2021,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
d) Ácido metilpropanoico.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2022-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica","el-enlace-ionico-y-sus-propiedades"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
de enlace que presenta.`,
      ...
      {
        id: "q-2022-A-2",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria","reacciones-de-adicion"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
d) (0,5 puntos) Justifique cómo afecta a la velocidad de reacción un aumento de temperatura.`,
      ...
      {
        id: "q-2022-A-5",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","concentracion-de-disoluciones","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos. Masas atómicas (u): O = 16,0; Al = 27,0; Cl = 35,5; K = 39,1.`,
      ...
      {
        id: "q-2022-B-1",
        topicSlugs: ["el-enlace-metalico-y-propiedades-de-los-metales","el-enlace-ionico-y-sus-propiedades","el-enlace-covalente-estructuras-de-lewis","geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta1",
      ...
      {
        id: "q-2022-B-2",
        topicSlugs: ["oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","macromoleculas-y-polimeros","reacciones-de-eliminacion"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
d) (0,5 puntos) $\\text{CH}_3-\\text{CHOH}-\\text{CH}_3 + \\text{H}_2\\text{SO}_4$ (concentrado) $\\rightarrow$`,
      ...
      {
        id: "q-2022-B-3",
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","principio-de-le-chatelier","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Dato. $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$.`,
      ...
      {
        id: "q-2022-B-4",
        topicSlugs: ["ph-de-acidos-y-bases-debiles"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Dato. $K_a(\\text{ácido hipocloroso}) = 3{,}2 \\cdot 10^{-8}$.`,
      ...
      {
        id: "q-2022-B-5",
        topicSlugs: ["pilas-galvanicas","potenciales-estandar-de-reduccion"],
        año: 2022,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Datos. $E^0$(V): $\\text{Cd}^{2+}$/Cd $= -0{,}40$; $\\text{Ag}^+$/Ag $= 0{,}80$.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2023-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","radio-atomico-y-radio-ionico","el-enlace-ionico-y-sus-propiedades"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
el elemento Y.`,
      ...
      {
        id: "q-2023-A-2",
        topicSlugs: ["reacciones-de-adicion","formulacion-de-compuestos-oxigenados-y-nitrogenados","oxidacion-reduccion-en-quimica-organica","reacciones-de-eliminacion"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
escriba sus fórmulas semidesarrolladas y nombre dichos compuestos.`,
      ...
      {
        id: "q-2023-A-3",
        topicSlugs: ["ph-de-acidos-y-bases-fuertes","ph-de-acidos-y-bases-debiles","concentracion-de-disoluciones"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
Dato. $K_a(\\text{ácido acético}) = 1{,}8 \\cdot 10^{-5}$.`,
      ...
      {
        id: "q-2023-A-5",
        topicSlugs: ["la-electrolisis","leyes-de-faraday-de-la-electrolisis","ph-de-acidos-y-bases-fuertes"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos. $F = 96485\\ \\text{C}\\cdot\\text{mol}^{-1}$. Masa atómica (u): Cu = 63,5.`,
      ...
      {
        id: "q-2023-B-1",
        topicSlugs: ["el-enlace-covalente-estructuras-de-lewis","el-enlace-metalico-y-propiedades-de-los-metales","el-enlace-ionico-y-sus-propiedades","fuerzas-intermoleculares"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta1",
      ...
      {
        id: "q-2023-B-2",
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","reacciones-de-adicion"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
caso afirmativo, formule y nombre el producto mayoritario de la reacción.`,
      ...
      {
        id: "q-2023-B-3",
        topicSlugs: ["ph-de-acidos-y-bases-fuertes","hidrolisis-de-sales"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Dato. $K_a(\\text{NH}_4^+) = 6{,}7 \\cdot 10^{-10}$.`,
      ...
      {
        id: "q-2023-B-4",
        topicSlugs: ["ley-de-los-gases-ideales-aplicada-a-reacciones","el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Datos. R = 0,082 atm·L·mol$^{-1}$·K$^{-1}$. Masas atómicas (u): H = 1,0; C = 12,0.`,
      ...
      {
        id: "q-2023-B-5",
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","ley-de-los-gases-ideales-aplicada-a-reacciones","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2023,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Datos. Masas atómicas (u): S = 32; Ca = 40. $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2024-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","radio-atomico-y-radio-ionico","el-enlace-ionico-y-sus-propiedades"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
      ...
      {
        id: "q-2024-A-2",
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","grupos-funcionales-y-nomenclatura-basica"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
i) $\\text{CH}_3-\\text{CH}=\\text{CH}-\\text{CHO}$ ii) $\\text{H}-\\text{COO}-\\text{CH}(\\text{CH}_3)-\\text{CH}_2-\\text{CH}_3$`,
      ...
      {
        id: "q-2024-A-3",
        topicSlugs: ["velocidad-de-reaccion","teoria-de-colisiones-y-energia-de-activacion","energia-libre-de-gibbs-y-espontaneidad","entalpias-de-formacion-y-de-enlace","entropia-y-segundo-principio-de-la-termodinamica"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
Datos. A 25 ºC, $\\Delta H_f^\\circ$ (kJ·mol$^{-1}$): NOCl = 51,7; NO = 90,3; $S^\\circ$ (J·mol$^{-1}$·K$^{-1}$): NO = 210,6; $\\text{Cl}_2$ = 223,0; NOCl = 261,7.`,
      ...
      {
        id: "q-2024-A-4",
        topicSlugs: ["ph-de-acidos-y-bases-fuertes","ph-de-acidos-y-bases-debiles","hidrolisis-de-sales"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Datos. $pK_a$(ácido propanoico) = 4,9; $pK_a$(ácido acético) = 4,75; $pK_b$(amoníaco) = 4,75.`,
      ...
      {
        id: "q-2024-B-1",
        topicSlugs: ["el-enlace-covalente-estructuras-de-lewis","geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta1",
...
c) (0,5 puntos) Justifique la polaridad de cada una.`,
      ...
      {
        id: "q-2024-B-2",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","grupos-funcionales-y-nomenclatura-basica","ley-de-los-gases-ideales-aplicada-a-reacciones","calculos-estequiometricos-con-reactivos-y-productos","riqueza-o-pureza-de-un-reactivo"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
Dato. $R = 0{,}082\\ \\text{atm}\\cdot\\text{L}\\cdot\\text{mol}^{-1}\\cdot\\text{K}^{-1}$.`,
      ...
      {
        id: "q-2024-B-4",
        topicSlugs: ["equilibrios-heterogeneos-y-solubilidad-kps","el-ph-y-el-producto-ionico-del-agua"],
        año: 2024,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Datos. $E°$(V): $\\text{Mn}^{2+}$/Mn $= -1{,}18$; $\\text{Fe}^{2+}$/Fe $= -0{,}44$; $\\text{Pb}^{2+}$/Pb $= -0{,}125$; $\\text{Ag}^+$/Ag $= 0{,}80$; $\\text{Au}^{3+}$/Au $= 1{,}52$.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2025-A-1",
        topicSlugs: ["energia-libre-de-gibbs-y-espontaneidad","entalpia-de-reaccion","entropia-y-segundo-principio-de-la-termodinamica","velocidad-de-reaccion","teoria-de-colisiones-y-energia-de-activacion"],
        año: 2025,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
una disminución de la temperatura.`,
      ...
      {
        id: "q-2025-A-2",
        topicSlugs: ["numeros-cuanticos-y-orbitales-atomicos","el-sistema-periodico-actual","electronegatividad-y-caracter-metalico"],
        año: 2025,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
electronegativo.`,
      ...
      {
        id: "q-2025-A-3",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria","grupos-funcionales-y-nomenclatura-basica"],
        año: 2025,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
c) (1 punto) Formule y nombre dos isómeros de cadena no cíclicos del hexano.`,
      ...
      {
        id: "q-2025-A-4",
        topicSlugs: ["ph-de-acidos-y-bases-debiles","hidrolisis-de-sales","disoluciones-reguladoras-tampon"],
        año: 2025,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
una disminución de la temperatura.`,
      ...
      {
        id: "q-2025-B-2",
        topicSlugs: ["el-enlace-covalente-estructuras-de-lewis","geometria-molecular-teoria-rpecv","fuerzas-intermoleculares"],
        año: 2025,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
d) (0,5 puntos) ¿Cuál/es es/son soluble/s en agua? Justifique la respuesta.`,
      ...
      {
        id: "q-2025-B-3",
        topicSlugs: ["reacciones-de-eliminacion","isomeria-estructural-y-estereoisomeria","formulacion-de-compuestos-oxigenados-y-nitrogenados","el-atomo-de-carbono-y-sus-enlaces","fuerzas-intermoleculares","reacciones-de-adicion"],
        año: 2025,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Dato. R = 0,0820 atm·L·mol$^{-1}$·K$^{-1}$.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2018-extra-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","radio-atomico-y-radio-ionico","el-atomo-de-bohr-y-los-espectros-atomicos"],
        año: 2018,
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2018-extra-A-3",
        topicSlugs: ["reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-sustitucion"],
        año: 2018,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2018-extra-A-4",
        topicSlugs: ["ley-de-los-gases-ideales-aplicada-a-reacciones","el-equilibrio-quimico-y-la-constante-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio"],
        año: 2018,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos apartado a); 0,75 puntos apartados b) y c).`,
      ...
      {
        id: "q-2018-extra-A-5",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","ley-de-los-gases-ideales-aplicada-a-reacciones","riqueza-o-pureza-de-un-reactivo","calculos-estequiometricos-con-reactivos-y-productos","concentracion-de-disoluciones"],
        año: 2018,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2018-extra-B-2",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria","oxidacion-reduccion-en-quimica-organica"],
        año: 2018,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,5 puntos apartado a) y c); 1 punto apartado b).`,
      ...
      {
        id: "q-2018-extra-B-4",
        topicSlugs: ["pilas-galvanicas","espontaneidad-de-las-reacciones-redox"],
        año: 2018,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      {
        id: "q-2018-extra-B-5",
        topicSlugs: ["concentracion-de-disoluciones","ph-de-acidos-y-bases-debiles"],
        año: 2018,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2019-extra-A-2",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-adicion","reacciones-de-eliminacion","reacciones-de-sustitucion"],
        año: 2019,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2019-extra-A-4",
        topicSlugs: ["calculos-estequiometricos-con-reactivos-y-productos","riqueza-o-pureza-de-un-reactivo","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron"],
        año: 2019,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2019-extra-B-2",
        topicSlugs: ["efecto-de-la-presion-y-la-temperatura-en-el-equilibrio","principio-de-le-chatelier"],
        año: 2019,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2019-extra-B-3",
        topicSlugs: ["formulacion-de-hidrocarburos","formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria"],
        año: 2019,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2019-extra-B-5",
        topicSlugs: ["concentracion-de-disoluciones","grado-de-disociacion","ph-de-acidos-y-bases-debiles"],
        año: 2019,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2020-extra-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","energia-de-ionizacion-y-afinidad-electronica","el-enlace-ionico-y-sus-propiedades"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2020-extra-A-2",
        topicSlugs: ["teorias-acido-base-arrhenius-y-br-nsted-lowry","hidrolisis-de-sales","ph-de-acidos-y-bases-fuertes","fuerza-de-acidos-y-bases-ka-y-kb"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,5 puntos apartados a) y c); 1 punto apartado b).`,
      ...
      {
        id: "q-2020-extra-A-4",
        topicSlugs: ["pilas-galvanicas","espontaneidad-de-las-reacciones-redox","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      {
        id: "q-2020-extra-A-5",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria","reacciones-de-eliminacion"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2020-extra-B-3",
        topicSlugs: ["ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","reacciones-de-oxidacion-reduccion","rendimiento-de-una-reaccion-quimica"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      {
        id: "q-2020-extra-B-4",
        topicSlugs: ["la-constante-kp-y-su-relacion-con-kc","grado-de-disociacion","el-equilibrio-quimico-y-la-constante-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos apartado a); 0,75 puntos apartados b) y c).`,
      ...
      {
        id: "q-2020-extra-B-5",
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","formulacion-de-hidrocarburos","oxidacion-reduccion-en-quimica-organica"],
        año: 2020,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      {
        id: "q-2021-extra-A-2",
        topicSlugs: ["velocidad-de-reaccion","mecanismos-de-reaccion-y-catalizadores","teoria-de-colisiones-y-energia-de-activacion"],
        año: 2021,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      {
        id: "q-2021-extra-A-4",
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","reacciones-de-eliminacion","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-adicion"],
        año: 2021,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      {
        id: "q-2021-extra-A-5",
        topicSlugs: ["ph-de-acidos-y-bases-debiles","grado-de-disociacion","fuerza-de-acidos-y-bases-ka-y-kb","hidrolisis-de-sales"],
        año: 2021,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y b); 0,5 puntos apartado c).`,
      ...
      {
        id: "q-2021-extra-B-3",
        topicSlugs: ["ph-de-acidos-y-bases-debiles","hidrolisis-de-sales","valoraciones-acido-base-e-indicadores"],
        año: 2021,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 1 punto.`,
      ...
      {
        id: "q-2021-extra-B-4",
        topicSlugs: ["ley-de-los-gases-ideales-aplicada-a-reacciones","grado-de-disociacion","el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc"],
        año: 2021,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      {
        id: "q-2021-extra-B-5",
        topicSlugs: ["espontaneidad-de-las-reacciones-redox","reacciones-de-oxidacion-reduccion","la-electrolisis","leyes-de-faraday-de-la-electrolisis"],
        año: 2021,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
b.2. El elemento con mayor radio atómico es el B.`,
      ...
      {
        id: "q-2022-extra-A-2",
        topicSlugs: ["grupos-funcionales-y-nomenclatura-basica","isomeria-estructural-y-estereoisomeria","reacciones-de-adicion","reacciones-de-eliminacion","macromoleculas-y-polimeros"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
una reacción de polimerización por condensación.`,
      ...
      {
        id: "q-2022-extra-A-3",
        topicSlugs: ["velocidad-de-reaccion","teoria-de-colisiones-y-energia-de-activacion","mecanismos-de-reaccion-y-catalizadores"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
energía de activación, ΔH, ΔS y ΔG.`,
      ...
      {
        id: "q-2022-extra-A-4",
        topicSlugs: ["grado-de-disociacion","fuerza-de-acidos-y-bases-ka-y-kb","ph-de-acidos-y-bases-debiles","hidrolisis-de-sales"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
neutro.`,
      ...
      {
        id: "q-2022-extra-A-5",
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos. Masas atómicas (u): H = 1,0; O = 16,0; Cl = 35,5; K = 39,1; Mn = 55,0.`,
      ...
      {
        id: "q-2022-extra-B-1",
        topicSlugs: ["geometria-molecular-teoria-rpecv","fuerzas-intermoleculares","el-enlace-ionico-y-sus-propiedades"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta1",
...
b) (1 punto) Indique la hibridación del átomo central y la geometría de las moléculas NH3 y CH4.`,
      ...
      {
        id: "q-2022-extra-B-2",
        topicSlugs: ["reacciones-de-sustitucion","reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-eliminacion"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
Dato. R = 0,082 atm·L·K−1·mol−1.`,
      ...
      {
        id: "q-2022-extra-B-4",
        topicSlugs: ["valoraciones-acido-base-e-indicadores","ph-de-acidos-y-bases-debiles","ph-de-acidos-y-bases-fuertes","concentracion-de-disoluciones"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
preparar la disolución.`,
      ...
      {
        id: "q-2022-extra-B-5",
        topicSlugs: ["ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","pilas-galvanicas","potenciales-estandar-de-reduccion","espontaneidad-de-las-reacciones-redox"],
        año: 2022,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Datos. E0 (V): MnO2/Mn2+ = 1,23; Au3+/Au = 1,50.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2023-extra-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica","radio-atomico-y-radio-ionico"],
        año: 2023,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
aumento de la temperatura.`,
      ...
      {
        id: "q-2023-extra-A-5",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","ley-de-los-gases-ideales-aplicada-a-reacciones","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2023,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta5",
...
d) (0,5 puntos) Justifique la fuerza intermolecular más importante que presenta cada una de ellas.`,
      ...
      {
        id: "q-2023-extra-B-2",
        topicSlugs: ["reacciones-de-adicion","reacciones-de-eliminacion","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2023,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
Dato. R = 0,082 atm·L·mol−1·K−1.`,
      ...
      {
        id: "q-2023-extra-B-4",
        topicSlugs: ["grado-de-disociacion","fuerza-de-acidos-y-bases-ka-y-kb","ph-de-acidos-y-bases-debiles","valoraciones-acido-base-e-indicadores"],
        año: 2023,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta4",
...
neutralizar 100 mL de la disolución de HA.`,
      ...
      {
        id: "q-2023-extra-B-5",
        topicSlugs: ["la-electrolisis","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","leyes-de-faraday-de-la-electrolisis"],
        año: 2023,
        convocatoria: "Extraordinaria",
        opcion: "B",
        bloque: "Pregunta5",
...
Datos. E0(V): Cd2+/Cd = − 0,40; O2/H2O = 1,23. F = 96485 C·mol−1. Masa atómica (u): Cd = 112,4.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2024-extra-A-1",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica","radio-atomico-y-radio-ionico","el-enlace-ionico-y-sus-propiedades"],
        año: 2024,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
las especies formadas.`,
      ...
      {
        id: "q-2024-extra-A-2",
        topicSlugs: ["reacciones-de-eliminacion","reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","isomeria-estructural-y-estereoisomeria","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2024,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
indique el tipo de reacción: B + ácido etanoico → ……..`,
      ...
      {
        id: "q-2024-extra-A-3",
        topicSlugs: ["grado-de-disociacion","fuerza-de-acidos-y-bases-ka-y-kb","ph-de-acidos-y-bases-debiles","ph-de-acidos-y-bases-fuertes"],
        año: 2024,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
justificadamente según su fuerza creciente como bases.`,
      ...
      {
        id: "q-2024-extra-A-4",
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","entalpia-de-reaccion","entalpias-de-formacion-y-de-enlace"],
        año: 2024,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
CH3OH (g) = −238,7.`,
      ...
      {
        id: "q-2024-extra-A-5",
        topicSlugs: ["la-electrolisis","leyes-de-faraday-de-la-electrolisis","concentracion-de-disoluciones","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2024,
        convocatoria: "Extraordinaria",
        opcion: "A",
        bloque: "Pregunta5",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos apartado a); 0,75 puntos apartados b) y c).`,
      ...
      },
      {
        ...
        topicSlugs: ["grupos-funcionales-y-nomenclatura-basica","formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y b); 0,5 puntos apartado c).`,
      ...
      },
      {
        ...
        topicSlugs: ["geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y b); 0,5 puntos apartado c).`,
      ...
      },
      {
        ...
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio","principio-de-le-chatelier"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["formulacion-de-hidrocarburos","oxidacion-reduccion-en-quimica-organica","reacciones-de-adicion","reacciones-de-eliminacion"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","espontaneidad-de-las-reacciones-redox","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y c); 0,5 puntos apartado b).`,
      ...
      },
      {
        ...
        topicSlugs: ["concentracion-de-disoluciones","grado-de-disociacion","ph-de-acidos-y-bases-debiles","hidrolisis-de-sales","valoraciones-acido-base-e-indicadores"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","electronegatividad-y-caracter-metalico","radio-atomico-y-radio-ionico","el-enlace-ionico-y-sus-propiedades"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
d) (0,5 puntos) Etanol + ácido metanoico $\\rightarrow$`,
      ...
      },
      {
        ...
        topicSlugs: ["grado-de-disociacion","fuerza-de-acidos-y-bases-ka-y-kb","ph-de-acidos-y-bases-debiles","hidrolisis-de-sales","ph-de-acidos-y-bases-fuertes"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
c) (1 punto) Justifique su polaridad y diga el tipo de fuerzas intermoleculares que presentan.`,
      ...
      },
      {
        ...
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
Datos. $K_s(\\text{AgCH}_3\\text{COO}) = 2{,}3 \\cdot 10^{-3}$; $K_a(\\text{CH}_3\\text{COOH}) = 1{,}8 \\cdot 10^{-5}$.`,
      ...
      },
      {
        ...
        topicSlugs: ["concentracion-de-disoluciones","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
...
Dato. Masa atómica (u): Ag = 107,9.`,
  ...
  },
  {
    ...
    preguntas: [
      {
        id: "q-2026-A-1",
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","pilas-galvanicas","potenciales-estandar-de-reduccion","equilibrios-heterogeneos-y-solubilidad-kps","el-ph-y-el-producto-ionico-del-agua"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta1",
...
Datos. $E^\\circ(V)$: $(\\text{Cu}^{2+}/\\text{Cu}) = 0{,}34$; $(\\text{NO}_3^-/\\text{NO}) = 0{,}96$. A 25 ºC, $K_s(\\text{Cu(OH)}_2) = 2{,}2 \\cdot 10^{-20}$.`,
      ...
      {
        id: "q-2026-A-2",
        topicSlugs: ["geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas","energia-reticular-y-ciclo-de-born-haber","fuerzas-intermoleculares","el-enlace-ionico-y-sus-propiedades"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta2",
...
siguientes procesos: i) ebullición del $\\text{CH}_3\\text{Br}$, ii) fusión del LiF.`,
      ...
      {
        id: "q-2026-A-3",
        topicSlugs: ["grupos-funcionales-y-nomenclatura-basica","formulacion-de-compuestos-oxigenados-y-nitrogenados","formulacion-de-hidrocarburos","isomeria-estructural-y-estereoisomeria","macromoleculas-y-polimeros","reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta3",
...
que la del compuesto (5).`,
      ...
      {
        id: "q-2026-A-4",
        topicSlugs: ["energia-libre-de-gibbs-y-espontaneidad","entalpias-de-formacion-y-de-enlace","entropia-y-segundo-principio-de-la-termodinamica","factores-que-afectan-a-la-velocidad-de-reaccion","mecanismos-de-reaccion-y-catalizadores","rendimiento-de-una-reaccion-quimica","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "A",
        bloque: "Pregunta4",
...
Datos. $E^\\circ(V)$: $(\\text{Cu}^{2+}/\\text{Cu}) = 0{,}34$; $(\\text{NO}_3^-/\\text{NO}) = 0{,}96$. A 25 ºC, $K_s(\\text{Cu(OH)}_2) = 2{,}2 \\cdot 10^{-20}$.`,
      ...
      {
        id: "q-2026-B-2",
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica","numeros-cuanticos-y-orbitales-atomicos","el-atomo-de-bohr-y-los-espectros-atomicos"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta2",
...
Datos. $h = 6{,}626 \\cdot 10^{-34}\\ \\text{J}\\cdot\\text{s}^{-1}$; $c = 3{,}00 \\cdot 10^{8}\\ \\text{m}\\cdot\\text{s}^{-1}$; $1\\ \\text{eV} = 1{,}602 \\cdot 10^{-19}\\ \\text{J}$.`,
      ...
      {
        id: "q-2026-B-3",
        topicSlugs: ["formulacion-de-hidrocarburos","reacciones-de-adicion","macromoleculas-y-polimeros","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-eliminacion"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta3",
...
iii) Butan-2-ol $+ \\text{H}_2\\text{SO}_4$ conc./calor $\\rightarrow$ D $+ \\text{HBr} \\rightarrow$ E`,
      ...
      {
        id: "q-2026-B-4",
        topicSlugs: ["concentracion-de-disoluciones","grado-de-disociacion","ph-de-acidos-y-bases-debiles","ph-de-acidos-y-bases-fuertes"],
        año: 2026,
        convocatoria: "Ordinaria",
        opcion: "B",
        bloque: "Pregunta4",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["el-enlace-covalente-estructuras-de-lewis","el-enlace-metalico-y-propiedades-de-los-metales","el-enlace-ionico-y-sus-propiedades","fuerzas-intermoleculares","propiedades-de-las-sustancias-covalentes"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["formulacion-de-hidrocarburos","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["la-electrolisis","leyes-de-faraday-de-la-electrolisis","reacciones-de-oxidacion-reduccion","concentracion-de-disoluciones"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["ph-de-acidos-y-bases-debiles","grado-de-disociacion","valoraciones-acido-base-e-indicadores"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y b); 0,5 puntos apartado c).`,
      ...
      },
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica","el-atomo-de-bohr-y-los-espectros-atomicos"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos cada apartado.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-eliminacion","reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","ley-de-los-gases-ideales-aplicada-a-reacciones","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2018,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos a); 0,75 puntos b) y c).`,
      ...
      },
      {
        ...
        topicSlugs: ["concentracion-de-disoluciones","ph-de-acidos-y-bases-fuertes","ph-de-acidos-y-bases-debiles","valoraciones-acido-base-e-indicadores"],
        año: 2019,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,75 puntos a) y b); 0,5 puntos c).`,
      ...
      },
      {
        ...
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2019,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["la-electrolisis","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","leyes-de-faraday-de-la-electrolisis","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2019,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["velocidad-de-reaccion","mecanismos-de-reaccion-y-catalizadores"],
        año: 2019,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,75 puntos a) y c); 0,5 puntos b).`,
      ...
      },
      {
        ...
        topicSlugs: ["grado-de-disociacion","ley-de-los-gases-ideales-aplicada-a-reacciones","el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc"],
        año: 2019,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","el-enlace-ionico-y-sus-propiedades"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","fuerza-de-acidos-y-bases-ka-y-kb","hidrolisis-de-sales","ph-de-acidos-y-bases-debiles"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y b); 0,5 puntos apartado c).`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 1 punto apartado a); 0,5 puntos apartados b) y c).`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","ley-de-los-gases-ideales-aplicada-a-reacciones","concentracion-de-disoluciones"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos apartado a); 0,75 puntos apartados b) y c).`,
      ...
      },
      {
        ...
        topicSlugs: ["el-enlace-covalente-estructuras-de-lewis","geometria-molecular-teoria-rpecv","el-enlace-ionico-y-sus-propiedades","fuerzas-intermoleculares"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["macromoleculas-y-polimeros","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["efecto-de-la-presion-y-la-temperatura-en-el-equilibrio","principio-de-le-chatelier","mecanismos-de-reaccion-y-catalizadores"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["la-electrolisis","leyes-de-faraday-de-la-electrolisis","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2020,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta4",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["el-sistema-periodico-actual","radio-atomico-y-radio-ionico","energia-de-ionizacion-y-afinidad-electronica","configuracion-electronica-de-los-elementos"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["ley-de-los-gases-ideales-aplicada-a-reacciones","el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
Puntuación máxima por apartado: 0,75 puntos apartados a) y b); 0,5 puntos apartado c).`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","macromoleculas-y-polimeros"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["grado-de-disociacion","fuerza-de-acidos-y-bases-ka-y-kb","valoraciones-acido-base-e-indicadores"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["pilas-galvanicas","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","potenciales-estandar-de-reduccion","espontaneidad-de-las-reacciones-redox"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta5",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["hidrolisis-de-sales"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Puntuación máxima por apartado: 0,5 puntos.`,
      ...
      },
      {
        ...
        topicSlugs: ["ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","riqueza-o-pureza-de-un-reactivo","calculos-estequiometricos-con-reactivos-y-productos"],
        año: 2021,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
...
d) (0,5 puntos) Formule y nombre un compuesto binario formado por los elementos B y C en su menor estado de oxidación, e indique el tipo de enlace que presenta.`,
      ...
      },
      {
        ...
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","ph-de-acidos-y-bases-fuertes"],
        año: 2022,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
d) (0,5 puntos) Un aumento de la temperatura disminuye la velocidad de reacción.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-eliminacion","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-adicion"],
        año: 2022,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
d) (0,5 puntos) Justifique su polaridad.`,
      ...
      },
      {
        ...
        topicSlugs: ["grupos-funcionales-y-nomenclatura-basica","formulacion-de-compuestos-oxigenados-y-nitrogenados","macromoleculas-y-polimeros"],
        año: 2022,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
Nombre el tipo de reacción y detalle el nombre de los grupos funcionales que intervienen en su síntesis.`,
      ...
      },
      {
        ...
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","principio-de-le-chatelier"],
        año: 2022,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Datos. $R = 0{,}082$ atm·L·mol$^{-1}$·K$^{-1}$. $F = 96485$ C·mol$^{-1}$. Masa atómica (u): Cu = 63,5.`,
      ...
      },
      {
        ...
        topicSlugs: ["hidrolisis-de-sales","teorias-acido-base-arrhenius-y-br-nsted-lowry"],
        año: 2022,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["geometria-molecular-teoria-rpecv","polaridad-de-enlaces-y-moleculas","fuerzas-intermoleculares","propiedades-de-las-sustancias-covalentes","el-enlace-ionico-y-sus-propiedades"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
c) (0,5 puntos) Justifique si el bromo tiene mayor punto de fusión que el bromuro de potasio.`,
      ...
      },
      {
        ...
        topicSlugs: ["formulacion-de-compuestos-oxigenados-y-nitrogenados","macromoleculas-y-polimeros","reacciones-de-eliminacion"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
c) (0,5 puntos) Indique el nombre del polímero que se obtiene a partir de cloroeteno, diga el tipo de reacción por la que se forma y formule la unidad repetitiva del polímero.`,
      ...
      },
      {
        ...
        topicSlugs: ["teorias-acido-base-arrhenius-y-br-nsted-lowry","ph-de-acidos-y-bases-debiles","concentracion-de-disoluciones"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
Datos. $K_a$ (HClO) = $3{,}2 \\cdot 10^{-8}$; $K_b$ ($\\text{NH}_3$) = $1{,}8 \\cdot 10^{-5}$. Masas atómicas (u): H = 1,0; O = 16,0; Cl = 35,5.`,
      ...
      },
      {
        ...
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
Datos. $R = 0{,}082$ atm·L·mol$^{-1}$·K$^{-1}$. Masas atómicas (u): H = 1,0; N = 14,0; S = 32,0.`,
      ...
      },
      {
        ...
        topicSlugs: ["la-electrolisis","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","potenciales-estandar-de-reduccion","leyes-de-faraday-de-la-electrolisis"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta5",
...
Datos. $F = 96485$ C·mol$^{-1}$. Masa atómica (u): Pb = 207,2. $E^0(V)$: $\\text{Br}_2/\\text{Br}^- = 1{,}09$; $\\text{Pb}^{2+}/\\text{Pb} = -0{,}13$.`,
      ...
      },
      {
        ...
        topicSlugs: ["el-atomo-de-bohr-y-los-espectros-atomicos","numeros-cuanticos-y-orbitales-atomicos","configuracion-electronica-de-los-elementos"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta1",
...
Dato. $R_H = 2{,}18 \\cdot 10^{-18}$ J.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-adicion","macromoleculas-y-polimeros","grupos-funcionales-y-nomenclatura-basica"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
c) (0,5 puntos) Esquematice y ajuste la reacción que tiene lugar por la unión sucesiva del monómero etanodiol con el monómero ácido pentanodioico. Detalle como producto la unidad repetitiva. Nombre el tipo de reacción y la clase de polímero que se obtiene.`,
      ...
      },
      {
        ...
        topicSlugs: ["velocidad-de-reaccion"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
b) (1 punto) Escriba la ecuación de velocidad y obtenga la constante de velocidad y sus unidades.`,
      ...
      },
      {
        ...
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio","mecanismos-de-reaccion-y-catalizadores"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta4",
...
d) (0,5 puntos) ¿Se modifica el equilibrio de la reacción del apartado c) al realizar la reacción en presencia de un catalizador?`,
      ...
      },
      {
        ...
        topicSlugs: ["reactivo-limitante-y-en-exceso","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2023,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos","el-sistema-periodico-actual","radio-atomico-y-radio-ionico"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
d) (0,5 puntos) Razone qué elemento tiene el menor radio atómico.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-eliminacion","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-sustitucion","reacciones-de-adicion"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
d) (0,5 puntos) $\\text{CH}_3-\\text{CH}=\\text{CH}_2 + \\text{H}_2\\text{O}$ / $\\text{H}^+$ →`,
      ...
      },
      {
        ...
        topicSlugs: ["entalpia-de-reaccion","entalpias-de-formacion-y-de-enlace","entropia-y-segundo-principio-de-la-termodinamica","energia-libre-de-gibbs-y-espontaneidad"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
c) (0,5 puntos) Con los datos disponibles, calcule $K_p$ a 300 ºC para el equilibrio: $\\frac{1}{2}\\text{A}_2(g) + \\frac{1}{2}\\text{B}_2(g) \\rightleftharpoons \\text{AB}(g)$.`,
      ...
      },
      {
        ...
        topicSlugs: ["riqueza-o-pureza-de-un-reactivo","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta5",
...
d) (0,5 puntos) Justifique su polaridad.`,
      ...
      },
      {
        ...
        topicSlugs: ["formulacion-de-hidrocarburos","formulacion-de-compuestos-oxigenados-y-nitrogenados","isomeria-estructural-y-estereoisomeria","reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
Datos. Masas atómicas (u): Cl = 35,5; Au = 197,0.`,
      ...
      },
      {
        ...
        topicSlugs: ["pilas-galvanicas","potenciales-estandar-de-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","espontaneidad-de-las-reacciones-redox","reacciones-de-oxidacion-reduccion"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta4",
...
Datos. $E^0(V)$: $\\text{Fe}^{2+}/\\text{Fe} = -0{,}44$; $\\text{Pb}^{2+}/\\text{Pb} = -0{,}13$; $\\text{Cu}^+/\\text{Cu} = 0{,}52$; $\\text{MnO}_4^-/\\text{Mn}^{2+} = 1{,}52$.`,
      ...
      },
      {
        ...
        topicSlugs: ["hidrolisis-de-sales","teorias-acido-base-arrhenius-y-br-nsted-lowry","fuerza-de-acidos-y-bases-ka-y-kb","ph-de-acidos-y-bases-debiles"],
        año: 2024,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta5",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["pilas-galvanicas","potenciales-estandar-de-reduccion","espontaneidad-de-las-reacciones-redox","reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","la-electrolisis","leyes-de-faraday-de-la-electrolisis"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
Datos. Masa atómica (u): Ag = 107,9. $F = 96485$ C·mol$^{-1}$.`,
      ...
      },
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos","radio-atomico-y-radio-ionico","energia-de-ionizacion-y-afinidad-electronica","el-enlace-ionico-y-sus-propiedades"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
c) (0,5 puntos) Considere los compuestos que se obtienen cuando se combina A: i) consigo mismo y ii) con el elemento C. Para cada uno de ellos escriba su fórmula y explique el tipo de enlace más probable.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-adicion","reacciones-de-eliminacion","oxidacion-reduccion-en-quimica-organica","macromoleculas-y-polimeros","isomeria-estructural-y-estereoisomeria"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
b) (1,25 puntos) Complete las siguientes reacciones identificando las sustancias A, B, C y D (fórmula y nombre): i) etanol + $\\text{H}_2\\text{SO}_4$/calor → A; ii) etanol + oxidante (frío) → B; iii) B + oxidante → C; iv) n A (polimerización) → D.`,
      ...
      },
      {
        ...
        topicSlugs: ["el-equilibrio-quimico-y-la-constante-kc","la-constante-kp-y-su-relacion-con-kc","entalpias-de-formacion-y-de-enlace","efecto-de-la-presion-y-la-temperatura-en-el-equilibrio"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta4",
...
Datos. Masa atómica (u): Ag = 107,9. $F = 96485$ C·mol$^{-1}$.`,
      ...
      },
      {
        ...
        topicSlugs: ["el-enlace-ionico-y-sus-propiedades","el-enlace-covalente-estructuras-de-lewis","geometria-molecular-teoria-rpecv","energia-reticular-y-ciclo-de-born-haber"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
c) (1 punto) Represente el ciclo de Born-Haber para la formación de NaCl (s): $\\text{Na}(s) + \\frac{1}{2}\\text{Cl}_2(g) \\rightarrow \\text{NaCl}(s)$, indicando el nombre de las energías implicadas en cada etapa.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","grupos-funcionales-y-nomenclatura-basica","reacciones-de-eliminacion","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
d) (0,5 puntos) La deshidratación del etanol, por el ácido sulfúrico, produce etino.`,
      ...
      },
      {
        ...
        topicSlugs: ["ph-de-acidos-y-bases-fuertes","ph-de-acidos-y-bases-debiles"],
        año: 2025,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta4",
    ...
    preguntas: [
      {
        ...
        topicSlugs: ["el-enlace-ionico-y-sus-propiedades","el-enlace-metalico-y-propiedades-de-los-metales","el-enlace-covalente-estructuras-de-lewis","geometria-molecular-teoria-rpecv","hidrolisis-de-sales"],
        año: 2026,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta1",
...
Dato. $pK_b$(amoniaco) = 4,75.`,
      ...
      },
      {
        ...
        topicSlugs: ["configuracion-electronica-de-los-elementos","numeros-cuanticos-y-orbitales-atomicos","el-sistema-periodico-actual","energia-de-ionizacion-y-afinidad-electronica"],
        año: 2026,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta2",
...
d) (0,5 puntos) La segunda energía de ionización del elemento A es 4560 kJ·mol$^{-1}$ mientras que la del elemento B es 1451 kJ·mol$^{-1}$. Justifique por qué es mayor la del elemento A.`,
      ...
      },
      {
        ...
        topicSlugs: ["isomeria-estructural-y-estereoisomeria","reacciones-de-adicion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados"],
        año: 2026,
        convocatoria: "Modelo",
        opcion: "A",
        bloque: "Pregunta3",
...
Dato. $pK_b$(amoniaco) = 4,75.`,
      ...
      },
      {
        ...
        topicSlugs: ["energia-reticular-y-ciclo-de-born-haber","propiedades-de-las-sustancias-covalentes","geometria-molecular-teoria-rpecv","fuerzas-intermoleculares"],
        año: 2026,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta2",
...
e) (0,5 puntos) Las fuerzas intermoleculares más fuertes que presenta el $\\text{PH}_3$ son debidas a enlaces de hidrógeno.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-sustitucion","oxidacion-reduccion-en-quimica-organica","formulacion-de-compuestos-oxigenados-y-nitrogenados","reacciones-de-eliminacion","grupos-funcionales-y-nomenclatura-basica","formulacion-de-hidrocarburos","isomeria-estructural-y-estereoisomeria","entalpia-de-reaccion","entalpias-de-formacion-y-de-enlace","ley-de-los-gases-ideales-aplicada-a-reacciones"],
        año: 2026,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta3",
...
Datos. A 298 K, $\\Delta H_f^0$ (kJ·mol$^{-1}$): $\\text{C}_4\\text{H}_{10}(g) = -125{,}7$; $\\text{H}_2\\text{O}(l) = -285{,}8$; $\\text{CO}_2(g) = -393{,}5$. $R = 0{,}0820$ atm·L·mol$^{-1}$·K$^{-1}$.`,
      ...
      },
      {
        ...
        topicSlugs: ["reacciones-de-oxidacion-reduccion","ajuste-de-reacciones-redox-por-el-metodo-del-ion-electron","riqueza-o-pureza-de-un-reactivo","calculos-estequiometricos-con-reactivos-y-productos","ph-de-acidos-y-bases-fuertes","ph-de-acidos-y-bases-debiles"],
        año: 2026,
        convocatoria: "Modelo",
        opcion: "B",
        bloque: "Pregunta4",
