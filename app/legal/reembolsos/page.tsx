    ...
    <main className="pau-bg-atmosphere" style={page}>
      <div style={container}>
        ...
        <Section title="2. Cómo solicitar el reembolso">
          <p style={p}>
            Envía un email a <a href="mailto:hola@kairo.es" style={aStyle}>hola@kairo.es</a> con el asunto <em>&quot;Solicitud de reembolso&quot;</em> e indica:
          </p>
          <ul style={ul}>
        ...
        <Section title="6. Contacto">
          <p style={p}>
            <a href="mailto:hola@kairo.es" style={aStyle}>hola@kairo.es</a> — respondemos en un plazo de 1–2 días laborables.
          </p>
        </Section>
