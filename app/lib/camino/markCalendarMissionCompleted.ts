...
// (UPDATE ... WHERE status='pending', 0 filas afectadas = ya estaba hecha o
// no existe) que ya usa /api/camino/complete-mission, pero SIN volver a
// llamar a awardXp(): el XP de esta acción ya lo otorga /api/simulacro con
// sourceType 'parcial_completion' (con su propio bonus de calidad por nota);
// llamarlo aquí también duplicaría el XP de la misma entrega.
//
