...
check('chat uses real Claude tool calling and never guesses missing data', chat.includes('CAMINO_CHAT_TOOLS') && chat.includes('Nunca inventes'))
check('chat tools never expose marking content as not-taught or creating simulacros', chat.includes('No tienes ninguna herramienta para marcar contenido'))
