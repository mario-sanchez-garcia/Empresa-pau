...
check('Camino shows week first and removes visual orientation target', camino.includes('data-testid="camino-week-overview"') && !camino.includes('data-testid="camino-orientation-target"') && !camino.includes('Días hasta selectividad'))
