...
const GROUPS: Array<{ id: MathGroupId; label: string; snippets: MathSnippet[] }> = [
  {
    ...
    label: "Básico",
    snippets: [
      { label: "a/b", title: "Fracción", latex: "\\frac{}{}", cursorOffset: 6 },
      { label: "√", title: "Raíz", latex: "\\sqrt{}", cursorOffset: 6 },
      { label: "x²", title: "Potencia", latex: "x^{}", cursorOffset: 3 },
      { label: "_{}", title: "Subíndice", latex: "_{}", cursorOffset: 2 },
  ...
  },
  {
    ...
    label: "Cálculo",
    snippets: [
      { label: "lim", title: "Límite", latex: "\\lim_{x \\to } ", cursorOffset: 12 },
      { label: "∫", title: "Integral definida", latex: "\\int_{}^{}  \\, dx", cursorOffset: 6 },
      { label: "∫ dx", title: "Integral indefinida", latex: "\\int  \\, dx", cursorOffset: 5 },
      { label: "d/dx", title: "Derivada", latex: "\\frac{d}{dx}" },
  ...
  },
  {
    ...
    label: "Álgebra",
    snippets: [
      { label: "mat 2x2", title: "Matriz 2x2", latex: "\\begin{pmatrix}\n & \\\\\n & \n\\end{pmatrix}", cursorOffset: 16 },
      { label: "|A|", title: "Determinante 2x2", latex: "\\begin{vmatrix}\n & \\\\\n & \n\\end{vmatrix}", cursorOffset: 16 },
      { label: "sistema", title: "Sistema de ecuaciones", latex: "\\begin{cases}\n \\\\\n \n\\end{cases}", cursorOffset: 14 },
  ...
  },
  {
    ...
    label: "Vectores",
    snippets: [
      { label: "u⃗", title: "Vector u", latex: "\\vec{u}", cursorOffset: 5 },
      { label: "AB⃗", title: "Vector AB", latex: "\\overrightarrow{AB}", cursorOffset: 16 },
  ...
  },
  {
    ...
    snippets: [
      ...
      { label: "unidad", title: "Unidad SI", latex: "\\,\\mathrm{}" },
    ],
  },
  {
    id: "quimica",
  ...
  },
  {
    ...
    label: "Plantillas",
    snippets: [
      { label: "∫a→b", title: "Integral definida", latex: "\\int_a^b f(x)\\,dx = F(b)-F(a)" },
      { label: "tangente", title: "Recta tangente", latex: "y - f(a) = f'(a)(x-a)" },
      { label: "sistema", title: "Sistema 2x2", latex: "\\begin{cases}\nax+by=c\\\\\ndx+ey=f\n\\end{cases}" },
      { label: "ampliada", title: "Matriz ampliada", latex: "\\left(\n\\begin{array}{cc|c}\n & & \\\\\n & & \n\\end{array}\n\\right)", cursorOffset: 33 },
