...
const FAQS = [
  {
    ...
    a: 'Ganas una base de XP garantizada cada vez que corriges un ejercicio con Kairo, en cualquier sección — la saques la nota que saques: entre 10 y 50 XP en una misión de Camino, 20 en un examen de Exámenes, 41 en una práctica parcial y 90 en un simulacro completo (la base de simulacros y parciales está pensada para ser proporcional a su duración real frente a una misión corta, no un número suelto). Si apruebas (5 o más), sumas un 25% extra de bonus; con un 7 o más, un 75%; con un 9 o más, el bonus es del 125%. La base nunca se reduce por una nota baja — el bonus solo suma, y cuanto mejor la nota, más pesa sobre el total. El XP total sube siempre — nunca baja.',
  },
  {
    q: '¿Qué es la racha?',
