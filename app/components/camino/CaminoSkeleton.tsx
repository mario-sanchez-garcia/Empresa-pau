...
// Silueta de Camino mientras carga. Se usa en DOS sitios y por eso vive aquí y
// no dentro de app/camino/loading.tsx:
//
//   1. app/camino/loading.tsx — la transición de ruta del servidor.
//   2. CaminoCalendarClient — el hueco real. Ahí el componente devolvía null
//      mientras resolvía sesión y perfil, y eso son segundos de pantalla en
//      blanco en un navegador sin copia local (móvil nuevo, ventana privada).
//      El loading.tsx no llega a cubrirlo porque el render de servidor de
//      /camino es instantáneo: se va antes de que empiece la espera de verdad.
//
// Dibuja cabecera + ticker, columna izquierda con objetivo, hero de 340 px y
// misiones, y el panel derecho de 288 px (ver CaminoCalendarClient.tsx).
export default function CaminoSkeleton() {
  return (
