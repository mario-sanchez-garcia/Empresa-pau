...
// XP de simulacros/parciales proporcional a su duración/esfuerzo real frente
// a una misión normal — antes eran números sueltos (50 y 30) sin relación
...
// daba 50 de base, apenas más que UNA misión corta.
//
...
// es más exigente que la misma cantidad de minutos repartida en varias
// misiones cortas con margen para pausar entre ellas — sin ese plus, un
// simulacro largo quedaría exactamente IGUAL que la suma de misiones
// equivalentes, y el objetivo es que quede claramente por encima.
//
...
// parcial es un bloque acotado, bastante más corto.
