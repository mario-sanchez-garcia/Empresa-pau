...
-- ══════════════════════════════════════════════════════════════════════
-- TAREA 2: Renumeración de headings ## desde 1 (por topic_slug)
-- Actualiza los 8 registros con el contenido corregido y renumerado.
-- ══════════════════════════════════════════════════════════════════════

-- algebra-lineal:matrices-operaciones
UPDATE curriculum_content
SET content_markdown = $FIXDOC$
...
-- analisis:derivadas-optimizacion
UPDATE curriculum_content
SET content_markdown = $FIXDOC$
...
-- probabilidad:probabilidad-combinatoria
UPDATE curriculum_content
SET content_markdown = $FIXDOC$
...
-- probabilidad:normal-tipificacion
UPDATE curriculum_content
SET content_markdown = $FIXDOC$
